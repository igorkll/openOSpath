...
function lib.getColorIndex()
    ...
    if depth == 4 then
        return {0xFFFFFF, 0xF2B233, 0xE57FD8, 0x99B2F2, 0xFEFE6C, 0x7FCC19, 0xF2B2CC, 0x4C4C4C, 0x999999, 0x4C99B2, 0xB266E5, 0x3366CC, 0x9F664C, 0x57A64E, 0xFF4C4C, 0x000000}
    else
